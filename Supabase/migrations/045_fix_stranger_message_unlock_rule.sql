-- 045_fix_stranger_message_unlock_rule.sql
-- Stranger DM rule:
-- 1) non-mutual users can send at most 1 message initially
-- 2) once the other side has replied at least once, both sides are fully unlocked
