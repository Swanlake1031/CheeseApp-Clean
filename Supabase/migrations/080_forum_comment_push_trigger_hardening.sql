-- 080_forum_comment_push_trigger_hardening.sql
-- Avoid runtime trigger failures when comments.system_role is absent in older schemas.
...
DECLARE
  ...
  v_title TEXT;
  v_body TEXT;
  v_system_role TEXT := COALESCE(to_jsonb(NEW)->>'system_role', '');
BEGIN
