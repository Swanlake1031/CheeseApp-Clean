...
SELECT
  ...
  profile.id,
  'forum',
  'How do you find study partners before the fall term?',
  'Any tips for finding a reliable study group on campus before the fall term?',
  'active',
  FALSE,
  132,
  profile.school_id
...
VALUES (
  ...
  '00000000-0000-0000-0000-000000000001',
  NULL,
  'Try joining campus clubs and agree on a regular study schedule.',
  FALSE,
  0,
  FALSE
)
